...
#'';
    shellAliases ={
      ...
      ll = "ls -l";
      ls = "ls --color=auto";
      update = "sudo nixos-rebuild switch --flake /home/ib/dots#desktop";
      upgrade = "sudo nixos-rebuild switch --flake /home/ib/dots#desktop --upgrade && sudo nix-collect-garbage -d";
